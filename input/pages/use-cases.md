...
*[Exchange flows and additional details](specification.html#request-routed-through-a-single-inbound-gateway-intermediary)*
...
*[Exchange flows and additional details](#destination-uses-an-inbound-gateway-intermediary-that-in-turn-uses-a-delegated-function-intermediary-to-deliver-certain-exchanges)*
...
*[Exchange flows and additional details](#originator-initiates-an-asynchronous-retrieval-of-data-from-a-destination-that-uses-an-inbound-gateway-intermediary)*
